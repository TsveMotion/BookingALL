        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="mb-4">
              ...
              />
              <p className="text-sm text-gray-400 mt-2">for Beauticians</p>
            </div>
            <p className="text-sm text-gray-400 leading-relaxed">
              The complete booking platform designed specifically for beauty professionals. Manage appointments, grow your business, and deliver exceptional service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/pricing" className="text-gray-400 hover:text-pink-400 transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <span className="text-gray-500">Hairdressers (Coming Soon)</span>
              </li>
              <li>
                <span className="text-gray-500">Barbers (Coming Soon)</span>
              </li>
              <li>
                <span className="text-gray-500">Nail Technicians (Coming Soon)</span>
              </li>
              <li>
                <span className="text-gray-500">Spa & Wellness (Coming Soon)</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a href="mailto:support@glambooking.co.uk" className="text-gray-400 hover:text-pink-400 transition-colors">
                  Contact Support
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <a 
                href="https://twitter.com/glambooking" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-pink-400 transition-colors"
                aria-label="Twitter"
              ...
              <a 
                href="https://facebook.com/glambooking" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-pink-400 transition-colors"
                aria-label="Facebook"
              ...
              <a 
                href="https://instagram.com/glambooking" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-pink-400 transition-colors"
