...
const navigation = {
  ...
  industries: [
    { name: 'Beauticians', href: '/' },
    { name: 'Hairdressers', href: '/hairdressers' },
    { name: 'Nail Technicians', href: '/nails' },
    { name: 'Spas & Wellness', href: '/spas' },
  ],
  legal: [
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm font-semibold leading-6 text-white">For Beauticians</h3>
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.forBeauticians.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-sm leading-6 text-gray-400 hover:text-white transition-colors"
